  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <img src="<?= base_url('assets_front/images/logo.png') ?>" alt="Sona Hotel" class="footer-logo img-fluid">
      ...
      <div class="row align-items-center text-center text-lg-start">
        ...
        <div class="col-lg-5 text-lg-end text-center">
          <p class="mb-0">
            ...
            This template is made with <i class="fas fa-heart text-danger"></i> by
            <a href="https://colorlib.com" class="colorlib-link" target="_blank">Colorlib</a>
          </p>
        </div>
