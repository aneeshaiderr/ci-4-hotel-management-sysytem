...
<section class="hero-section position-relative text-white">
    <div class="owl-carousel owl-theme" id="heroCarousel">
        ...
        <div class="hero-item d-flex align-items-center"
             style="background: url('<?= base_url('assets_front/images/hero/hero-1.jpg') ?>') center/cover no-repeat;">
            <div class="container">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="bg-white p-4 rounded shadow w-100">
                            ...
                            <form>
                                ...
                                <button type="submit" class="bk btn-warning-custom w-100 mt-2">
                                    Check Availability
                                </button>
                            </form>
                        </div>
        ...
        <!-- Slide 2 -->
        <div class="hero-item d-flex align-items-center"
             style="background: url('<?= base_url('assets_front/images/hero/hero-2.jpg') ?>') center/cover no-repeat;">
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-lg-6 text-center text-lg-start">
                        <div class="hero-text">
                            ...
                            <p class="mb-4 fs-6 fs-md-5 text-white">
                                Here are the best hotel booking sites, including recommendations for international travel and for finding low-priced hotel rooms.
                                Book the best hotels for your perfect holidays and business trips with Sona.
                            </p>
                            <a href="#" class="btn btn-outline-light-custom btn-lg">Discover Now</a>
                        </div>
                    </div>
        ...
        <!-- Slide 3 -->
        <div class="hero-item d-flex align-items-center"
             style="background: url('<?= base_url('assets_front/images/hero/hero-3.jpg') ?>') center/cover no-repeat;">
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-lg-6 text-center text-lg-start">
                        <div class="hero-text">
                            <h1 class="display-4 mb-3 text-white">Sona A Luxury Hotel</h1>
                            <p class="mb-4 fs-6 fs-md-5 text-white">
                                Experience unmatched hospitality and world-class service in Sona Hotel.
                            </p>
                            <a href="#" class="btn btn-outline-light-custom btn-lg">Discover Now</a>
                        </div>
                    </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-12 col-lg-6">
        <div class="row g-3 about-img">
          <div class="col-6">
            <img
              src="<?= base_url('assets_front/images/about/about-1.jpg') ?>"
              alt="Hotel Exterior"
          ...
          <div class="col-6">
            <img
              src="<?= base_url('assets_front/images/about/about-2.jpg') ?>"
              alt="Hotel Interior"
              class="img-fluid rounded"
            />
          </div>
  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('<?= base_url('assets_front/images/room/room-b1.jpg') ?>');">
      ...
      <!-- Room 2 -->
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('<?= base_url('assets_front/images/room/room-b2.jpg') ?>');">
          <div class="hr-text text">
            <h3>King Room</h3>
      ...
      <!-- Room 3 -->
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('<?= base_url('assets_front/images/room/room-b3.jpg') ?>');">
          <div class="hr-text text">
            <h3>Deluxe Room</h3>
      ...
      <!-- Room 4 -->
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('<?= base_url('assets_front/images/room/room-b4.jpg') ?>');">
          <div class="hr-text text">
            <h3>Family Room</h3>
    ...
    <div class="owl-carousel owl-theme" id="testimonialCarousel">
      ...
      <div class="testimonial-item mx-auto py-4 px-3" style="max-width: 800px;">
        ...
        <div class="text-center">
          ...
          <img src="<?= base_url('assets_front/images/testimonial-logo.png') ?>" alt="testimonial logo" class="img-fluid testimonial-logo d-block mx-auto">
        </div>
      </div>
...
<section class="py-5 blog-section">
  <div class="container">
    ...
    <div class="blog-wrapper">
      <div class="blog-item">
        <img src="<?= base_url('assets_front/images/room/room-b4.jpg') ?>" alt="Tremblant Trip">
      ...
      <div class="blog-item">
        <img src="<?= base_url('assets_front/images/room/room-5.jpg') ?>" alt="Camping">
      ...
      <div class="blog-item">
        <img src="<?= base_url('assets_front/images/room/room-6.jpg') ?>" alt="Copper Canyon Event">
      ...
      <div class="blog-item wide">
        <img src="<?= base_url('assets_front/images/room/room-b2.jpg') ?>" alt="Iqaluit Trip">
        <span class="blog-tag">Event</span>
        <div class="blog-content">
      ...
      <div class="blog-item tall">
        <img src="<?= base_url('assets_front/images/room/room-b3.jpg') ?>" alt="Barcelona Travel">
