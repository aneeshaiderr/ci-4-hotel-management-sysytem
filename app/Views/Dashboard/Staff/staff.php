                                        ...
                                        <?php foreach ($users as $user) : ?>
                                            <tr>
                                                ...
                                                <td class="userprofile-action-btns">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form method="POST" action="<?= base_url('user/delete') ?>" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                                        <?= csrf_field() ?>
            ...
            <div class="col profile-column d-flex justify-content-end">
                <div class="card text-center w-100 profile-outer-card">
                    <div class="card-body profile-inner-card-body">
                        ...
                        <img src="<?= base_url('img/avatar-3.jpg') ?>" class="userprofile-pic" alt="Profile picture">
