        ...
        columns: [
            ...
            { data: 'check_out' },
            {
                ...
                render: function(status) {
                    ...
                    else if(status === 'inactive') return '<span class="badge bg-danger">Inactive</span>';
                    else return `<span class="badge bg-warning text-dark">${status}</span>`;
                }
            },
            {
                data: 'id',
                ...
                render: function(id) {
                    return `
                        <div class="d-flex">
                            <a href="<?= base_url('reservation/edit') ?>/${id}" class="btn btn-sm btn-primary me-1">View</a>
                            <form class="d-inline m-0" method="POST" action="<?= base_url('reservation/delete') ?>" onsubmit="return confirm('Are you sure?');">
